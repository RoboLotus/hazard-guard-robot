...
이 중 `bale_storage`만 관리실 옆(90° 회전, 중심 2.80, −1.00)으로 옮겨 압축기와의
겹침을 해소했습니다. 나머지는 원본 그대로 둡니다. 그것까지 손대려면 설비 한
개를 옮기는 수준이 아니라 시설을 재설계해야 합니다. 변경 지점은
...
| 항목 | 값 |
|---|---|
| 주행 가능 면적 | 3.98 m² (방의 8%) |
| 주행 범위 | x −1.81 … 1.41 m, y −1.79 … −0.11 m |
| 최대 통로 폭 | 2.64 m |
...
| bale_storage \* | 2.27 m | 0.71 m | 0.61 m | 2.80 | −1.00 |
| control_room | 1.43 m | 0.87 m | 0.48 m | 3.14 | −1.80 |

`*` 표시는 원본 배치에서 옮긴 설비입니다.
